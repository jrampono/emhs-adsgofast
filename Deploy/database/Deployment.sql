...
GO
PRINT N'Rename refactoring operation with key 6076314c-821f-4594-98a8-186c526946b2 is skipped, element [dbo].[TaskMaster].[ScheduleId] (SqlSimpleColumn) will not be renamed to ScheduleMasterId';


GO
PRINT N'Rename refactoring operation with key c94184fb-7030-4bd4-bf28-950dd778332f is skipped, element [dbo].[TaskInstance].[ScheduleInstance] (SqlSimpleColumn) will not be renamed to ScheduleInstanceId';
